	...
	<div class="wrapper">
		<div class="main-content">
			...
			<form commandName="MemberDTO" id="createForm"
				action="/fooriend/search_result_pwd.htm" method="post">
				<input type="hidden" id="m_id_yn" name="m_id_yn" value="N">
				<div class="container">
					<!-- Outer Row -->
										...
										<div class="col-lg-6">
											<div class="p-5">
												<div class="text-center">
													<h1 class="h4 text-gray-900 mb-2">비밀번호를 찾으시겠습니까?</h1>
													<p class="mb-4"></p>
												</div>
												...
												<a href="javascript:void(0)"
													...
													class="form-control btn btn-primary submit px-3">비밀번호
													찾기 </a>
												<hr>
