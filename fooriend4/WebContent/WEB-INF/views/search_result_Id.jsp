	...
	<div class="wrapper">
		<div class="main-content">
			<nav class="navbar navbar-expand-xl nav_area sticky">
				<div class="container">
					<div class="logo">
						<a href="mainPage.htm" class="logo-light">Fooriend</a> <a href="main.htm"
									...
									<div class="col-lg-6">
										<div class="p-5">
											<div class="text-center">
												<h1 class="h4 text-gray-900 mb-2">아이디 찾기 결과</h1>
												<br>
												<p class="mb-4"></p>
											</div>
											<div class="form-control">
												<c:choose>
													...
													<c:otherwise>
														<p class="mb-4">아이디는 ${MemberDTO.mid} 입니다.</p>
													</c:otherwise>
												</c:choose>
											</div>
											...
											<div class="w-50 text-md-right">
												<a href="/fooriend/search_pwd.htm" style="color: #fff"><font
													color="black">비밀번호 찾기</font></a> <a
													href="/fooriend/register.htm" style="color: #fff"><font
													color="black">회원가입 하러가기</font></a> <a href="/fooriend/home.htm"
													style="color: #fff"><font color="black">로그인 하러가기</font></a>
											</div>
